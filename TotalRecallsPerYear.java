...
public class TotalRecallsPerYear extends Configured implements Tool {
	...
	public static class MapClass extends MapReduceBase implements
		...
		public void map(LongWritable key, Text value,
			...
			if(data[15].length() > 3){
		    String temp = data[14].toUpperCase()+" "+data[15].substring(0, 4);
			word.set(temp);
	...
	public int run(String[] args) throws Exception {
		JobConf conf = new JobConf(getConf(), TotalRecallsPerYear.class);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new TotalRecallsPerYear(), args);
		System.exit(res);
	}
}
